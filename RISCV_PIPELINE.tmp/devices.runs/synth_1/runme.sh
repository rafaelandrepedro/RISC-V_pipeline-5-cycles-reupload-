...
HD_PWD='/home/computador/Desktop/Xilinx/RISCV_PIPELINE/RISCV_PIPELINE.tmp/devices.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log devices.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source devices.tcl
